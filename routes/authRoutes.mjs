...
import { protectRoutetMiddleware, uploadUserPhotoMiddleware } from '../middlewares/middlewares.mjs';
import catchAsync from '../utils/catchAsync.mjs';

const router = Router();

router.route('/signup').post(uploadUserPhotoMiddleware,catchAsync(signupController));
